...
//		public void sendMessage(Limite message, Span spanPai, String topico, Tracer tracer, org.springframework.kafka.core.KafkaTemplate<String, Limite> kafkaTemplate, String spanId)
		public void sendMessage(Limite message, Span spanPai, String topico, Tracer tracer, org.springframework.kafka.core.KafkaTemplate<String, Limite> kafkaTemplate, String spanId, String idCorrelacao, String idTransacao, Boolean syntheticTransaction)
		{
			LOG.debug(MessagesEnum.GM4C_LIM0002D.getCodAndDescription(), topico);
			...
			Message<Limite> mensagem = MessageBuilder
					.withPayload(message)
	        ...
	        LOG.debug(MessagesEnum.GM4C_LIM0003D.getCodAndDescription(), mensagem);
			span.finish();
		}
